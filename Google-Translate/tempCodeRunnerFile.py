...
# from google_trans_new import google_translator  # Using google-trans-new for translation
from googletrans import LANGUAGES  # We still use this part for supported languages
